...
<div className="bg-[#3B3B3B]">
  <h1 className="font-bold tracking-widest text-center bg-[#3B3B3B] text-[5vw] md:text-[4vw] lg:text-[3vw] xl:text-[200px] text-[#676767]">
    TRENDING<br/>
    <span className="text-white absolute top-[220%] left-[50%] transform -translate-x-1/2 -translate-y-1/2 text-[2vw] md:text-[1.5vw] lg:py-12 lg:text-[50px] xl:text-[62px w-full]">
      Top Collection
    </span>
  </h1>
</div>
...
<h1 class="text-[#3D3D3D] font-bold text-[200px] tracking-widest text-center bg-[#666666]">EXPLORE<br/><span class="text-white text-[40px] absolute top-[380%] left-[50%] transform -translate-x-1/2 -translate-y-1/2 w-full">Browse All Categories</span></h1>
</div>
...
<div className="bg-[#666666] pb-5">
  <h1 className="font-bold tracking-widest w-full text-center text-responsive  bg-gradient-to-r from-[#C2B2BD] via-[#C2B2BD] to-[#ADC0C4] text-transparent bg-clip-text 
               ...
               text-[#676767]">
    NEW REALEASE  <br/>
    <span className="text-white absolute top-[465%] left-[50%] transform -translate-x-1/2 -translate-y-1/2 
                     text-[2vw] md:text-[1.5vw] lg:py-12 lg:text-[50px] xl:text-[62px]">
      Get New One!</span>
      </h1>
</div>
