  ...
  return (
    <body>
      ...
      <div className="bg-gradient-to-b from-black to-[#3B3B3B]">
        <CardConsole/> {/* Console card component */}
      </div>
      ...
      <div className="bg-gradient-to-t from-[#666666] to-[#3B3B3B]">
        <CardCollection/> {/* Collection card component */}
      </div>
      ...
      <div className="bg-[#666666]">
        <CardCategory/> {/* Category card component */}
        <div className="bg-[#666666] -mt-5 flex justify-center ">
      ...
      <div className="bg-[#666666]">
        <CardAccessories/> {/* Accessories card component */}
      </div>
      <footer className="flex items-center justify-center w-full h-full bg-[#666666]">
        <Image src="/footerHome.svg" width={1000} height={1000} alt="footer"/>
      </footer>
    </body>
  );
}