        ...
        <div className="grid grid-cols-3 gap-12 gap-x-20 max-w-screen-lg mx-auto">
          ...
          <div className="bg-[#DCDCDC] rounded-lg shadow-lg overflow-hidden w-[340px]">
            ...
            <div className='flex justify-between items-center text-center'>
              ...
              <h5 className="text-gray-900 text-xl font-medium mb-2">Splatoon 3</h5>
            </div>
          </div>
          ...
          <div className="bg-[#DCDCDC] rounded-lg shadow-lg overflow-hidden w-[340px]">
            ...
            <div className='flex justify-between items-center text-center'>
              ...
              <h5 className="text-gray-900 text-xl font-medium mb-2">Luigi's Mansion 3</h5>
            </div>
          </div>
          ...
          <div className="bg-[#DCDCDC] rounded-lg shadow-lg overflow-hidden w-[340px]">
            ...
            <div className='flex justify-between items-center text-center'>
              ...
              <h5 className="text-gray-900 text-xl font-medium mb-2">The Legend Of Zelda</h5>
            </div>
          </div>
          ...
          <div className="bg-[#DCDCDC] rounded-lg shadow-lg overflow-hidden w-[340px]">
            ...
            <div className='flex justify-between items-center text-center'>
              ...
              <h5 className="text-gray-900 text-xl font-medium mb-2">Kena: Bridge of Spirits</h5>
            </div>
          </div>
          ...
          <div className="bg-[#DCDCDC] rounded-lg shadow-lg overflow-hidden w-[340px]">
            ...
            <div className='flex justify-between items-center text-center'>
              ...
              <h5 className="text-gray-900 text-xl font-medium mb-2">Fortnite</h5>
            </div>
          </div>
        </div>
      </div>
