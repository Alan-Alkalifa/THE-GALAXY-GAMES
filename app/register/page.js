    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-t from-[#656565] to bg-[#0D0D0D] px-4 py-8 md:p-0">
        <div className='flex flex-col md:flex-row bg-gradient-to-t from-[#292929] to bg-[#111111] rounded-2xl md:rounded-full w-full max-w-4xl mx-auto'>
          ...
          <div className="w-full md:max-w-md p-6 md:p-8 space-y-4 bg-gradient-to-t from-[#292929] to bg-[#111111] rounded-2xl md:rounded-e-3xl shadow-md">
            <h1 className='text-bold text-2xl md:text-3xl text-white mb-6'>Register</h1> 
            ...
            <p className="text-sm text-center text-gray-400 py-6 md:py-8"> ----- Or register with email ----- </p>
            ...
            <div className="flex items-start space-x-2 mt-4">
              <input 
                type="checkbox" 
                className="w-4 h-4 accent-green-400 mt-1"
              />
              <label className="text-sm text-gray-400">
                I have read and accept the Terms of 
                <span className='text-green-400 block md:inline'> Service & Privacy Policy *</span>
              </label>
            </div>
            <button className="w-full py-3 mt-6 text-white bg-[#666666] rounded-full hover:bg-slate-700 text-sm md:text-base">
              Continue
            </button>
