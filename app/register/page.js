  ...
  return (
    ...
    <div className="flex items-center justify-center h-screen bg-gradient-to-t from-[#656565] to bg-[#0D0D0D]">
      ...
      <div className="w-full max-w-md p-8 space-y-3 bg-gradient-to-t from-[#292929] to bg-[#111111] rounded-e-3xl shadow-md">
        <h1 className='text-bold text-xl'>Register</h1> 
        ...
        <p className="text-sm text-center text-gray-400"> ----- Or login with email ----- </p>
        <div className="space-y-4">
          <input type="text" placeholder="Name" className="bg-[#111111] w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-green-400"/>
          ...
          <input type="password" placeholder="Repeat Password" className="bg-[#111111] w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-green-400"/>
          </div>
        </div>
        <div className="flex items-center">
          <input type="checkbox" className="w-4 h-4 accent-green-400"/>
          <label className="ml-2 text-sm text-gray-400">I have read and accept the Terms of <br/> <span className='text-green-400'>Service & Privacy Policy *</span></label>
        </div>
         <button className="w-full py-2 mt-4 text-white bg-[#666666] rounded-full hover:bg-slate-700">Continue</button>
